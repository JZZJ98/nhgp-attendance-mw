...
export default async function handler(req, res) {
  ...
  try {
    ...
    // ----- YOUR SITES -----
    const sites = {
      // Toa Payoh from your earlier coordinates
      'SGCLINIC01': {
        site_id: 'SGCLINIC01',
        lat: 1.3345499,
        lng: 103.858986,
        radius: Number(process.env.ALLOWED_RADIUS_M || 170),
      },
      // add more sites here...
    };
    // ----------------------
    ...
    // Create short session (best effort; may hit different instance later)
    ...
    // Set cookies: sid (HttpOnly) + site/tag (fallback across instances)
