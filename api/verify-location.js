...
export default async function handler(req, res) {
  ...
  try {
    ...
    // --- IMPORTANT: cross-site cookie for GitHub Pages ---
    res.setHeader('Set-Cookie', `sid=${sessionId}; Path=/; HttpOnly; Secure; SameSite=None; Max-Age=600`);
